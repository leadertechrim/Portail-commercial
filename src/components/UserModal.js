      ...
      <div className="modal-content">
        ...
        <div className="modal-header" style={{ background: "#f67800", position: "relative", display: "flex", alignItems: "flex-end", justifyContent: "space-between", padding: "0 24px 14px", minHeight: "80px", borderRadius: "16px 16px 0 0" }}>
          <h2 style={{
            ...
            <i className={`fas ${user ? "fa-user-edit" : "fa-user-plus"}`} style={{ fontSize: "1.1rem", opacity: .85 }}></i>
            {isViewMode
            ...
            {!isViewMode && (
              <button type="submit" className="save-btn" disabled={loading}>
                {loading
                  ...
                  : <><i className="fas fa-check" style={{ marginRight: 7 }}></i>{user ? "Mettre à jour" : "Créer l'Utilisateur"}</>
                }
              </button>
            )}
          </div>
