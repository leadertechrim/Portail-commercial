      ...
      <div className="page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", flexWrap: "nowrap" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14, flexShrink: 0 }}>
          ...
          <h1 style={{ fontSize: "1.15rem", fontWeight: 700, margin: 0, display: "flex", alignItems: "center", gap: 8, whiteSpace: "nowrap" }}>
            <i className="fas fa-user-tie" style={{ color: "#f67800", fontSize: "1rem" }}></i>
            Personnel
          </h1>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          {canCreate && (
            <button className="add-personnel-btn" onClick={() => setIsAddModalOpen(true)} style={{ height: "36px", fontSize: "0.82rem" }}>
          ...
          <tbody>
            {filteredPersonnel.length === 0 ? (
              ...
              filteredPersonnel.map((person) => (
                <tr key={person._id} id={`item-${person._id}`}>
                  <td>
                  ...
                  <td>
                    {person.email
                      ? <a href={`mailto:${person.email}`} style={{ color: "#f67800", textDecoration: "none", fontSize: ".88rem" }}>
                          {person.email}
                        </a>
                      : "—"}
                  </td>
